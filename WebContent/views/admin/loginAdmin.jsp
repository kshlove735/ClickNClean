        ...
        <div id="content">
            <div id="content_inner">
                <div id="login_form">
                    ...
                    <div id="input_form">
                        <form action="/admin/loginAdmin.do" method="post" id="input_form_center">
                            <!--   <input type="hidden" name="roll" value="ad-1">-->
                            <input type="text" name="adminId" class="input" placeholder="아이디를 입력해주세요."><br><br>
                            <input type="password" name="adminPwd" class="input" placeholder="비밀번호를 입력해주세요."><br>
