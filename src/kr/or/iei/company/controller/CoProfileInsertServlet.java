...
/**
 * Servlet implementation class CoProfileInsertServlet
 */
@WebServlet("/co/coProfileInsert.do")
public class CoProfileInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CoProfileInsertServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = ciService.insertCompanyInfo(co, coId);
		
		RequestDispatcher view = request.getRequestDispatcher("/views/company/insertCompanyInfo.jsp");
