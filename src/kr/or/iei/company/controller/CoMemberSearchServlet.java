...
/**
 * Servlet implementation class CoMemberSearchServlet
 */
@WebServlet("/co/coMemberSearch.do")
public class CoMemberSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CoMemberSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String, Object> map = coMService.selectSearchMember(coId, currentPage, memberKey, searchType);
